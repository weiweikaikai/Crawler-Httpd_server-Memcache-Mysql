...
/* Define to 1 to enable assertging code. */
#define DASSERT 0
...
#define HAVE_MEMCACHED_LIGHT_BINARY 1
...
/* HEX representation of VERSION */
#define HEX_VERSION 1
...
#define MYSQLD_BINARY "/alidata/server/mysql/bin/mysqld"
...
#define PACKAGE_STRING "libmemcached 1.0.12"
